			...
			<div class="row">
				...
				<div class="col-md-2 col-sm-3">
					<div class="footer_company">
						...
						<ul class="list-unstyled">
							<li class="footer_company_item"><a href="#">
								О СЕРВИСЕ
							</a></li>
							<li class="footer_company_item"><a href="#">
								КЛИЕНТАМ
				...
				<div class="row">
					<div class="col-lg-5 col-md-4">
						<p class="footer_bottom_copy">
							&copy; 2017 <a href="#">Merkury</a>, ltd Все&nbsp;права&nbsp;защищены
						</p>
					</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				<form action="#" method="post" name="registration" class="form-horizontal">
					...
					<p class="form_text">
						Есть аккаунт KRON?
						<a href="javascript:void(0);" data-toggle="modal" data-target="#login" data-dismiss="modal">
							Вход
						</a>
					</p>
					...
					<div class="form-group form-checked">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<label for="inputAgreement" class="control-label">
								Я принимаю
								<a href="javascript:void(0);" data-toggle="modal" data-target="#agreement" data-dismiss="modal">
				...
				<form action="#" method="post" name="login" class="form-horizontal">
					...
					<div class="form-group form-link">
						<p class="control-label">
							...
							<a href="javascript:void(0);" data-toggle="modal" data-target="#registration" data-dismiss="modal">
								Регистрация
							</a>
						</p>
					</div><!-- .form-link -->
